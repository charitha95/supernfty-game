...
class App extends React.Component {
  ...
  setEndValue(index, value) {
    ...
    var row = rows[index];
    row.endValue = value;
    console.log("index: " + index + " value: " + value + " endValue: " + value);
    rows[index] = row;
    this.setState({ rows: rows });
  }
